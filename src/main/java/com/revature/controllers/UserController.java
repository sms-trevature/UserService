...
public class UserController {
	...
	@GetMapping
	List<User> findAll() {
		List<User> myUserList=userService.findAll(); 
		System.out.println("ALL MY USERS: " + myUserList);
		return myUserList;
	}
	...
	public ResponseEntity<User> findByEmail(@PathVariable String email) {
		...
		System.out.println( " LKAJDSF;LKJASD;LFJK ALDSFN,SNDBFVUIHEDOF WEOPIRUWQEPOIRU ASDHFAKSJDF LASJDFASLDFH ");
